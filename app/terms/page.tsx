...
export default function TermsOfService() {
  return (
    <div className="flex flex-col items-center justify-center w-full">
      ...
      <div className="pt-30 pb-5 px-5 flex flex-col gap-2 min-h-screen h-full w-full text-(--gray)">
        ...
        <div>
          <span>
            ...
            incapacidade de usar os materiais em{" "}
            <a
              href="https://palpita-muito.vercel.app"
              className="text-blue-700 font-bold"
            >
        ...
        <div>
          <span>
            ...
            pode fazer alterações nos materiais contidos em seu site a qualquer
            momento, sem aviso prévio. No entanto,{" "}
            <a
              href="https://palpita-muito.vercel.app"
              className="text-blue-700 font-bold"
            >
        ...
        <div>
          <span>
            ...
            qualquer link não implica endosso por{" "}
            <a
              href="https://palpita-muito.vercel.app"
              className="text-blue-700 font-bold"
            >
